...
import { FilterByStatePipe } from "./pipes/filterByState.pipe";
import { FilterByDispPipe } from "./pipes/filterByDisp.pipe";
import { ProductService } from "./services/product.service";
import { ProductbraService   } from "./services/ProductbraService";
...
@NgModule({
	...
	providers: [AuthService, AuthGuard, AdminGaurd, ProductService,
    ProductbraService, UserService, FormBuilder]
})
