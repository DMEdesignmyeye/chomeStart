...
import { FavouriteProduct } from './productbra.service';
@Injectable()
export class ProductbraService {
  ...
  constructor(private db: AngularFireDatabase, private authService: AuthService, private toastrService: ToastrService) {
...
*/
  ...
  getUsersFavouriteProduct() {
    ...
    this.favouriteProducts = this.db.list('favouriteProducts', (ref) => ref.orderByChild('userId').equalTo(user.$key));
  ...
  addFavouriteProduct(data: Product): void {
    ...
    a.push(data);
    this.toastrService.wait('Agregando Propiedad', 'Propiedad agregado a favoritos');
    setTimeout(() => {
...
*/
  ...
  addToCart(data: Product): void {
    ...
    a.push(data);
    this.toastrService.wait('Agregando Propiedad a tu carrito', 'Propiedad Agregado Exitosamente');
    setTimeout(() => {
